...
@Getter
public class MasterSlaveConnection implements Connection {

    private MasterSlaveDataSource masterSlaveDataSource;

    private Map<String, DataSource> dataSourceMap;

    public MasterSlaveConnection(MasterSlaveDataSource masterSlaveDataSource, Map<String, DataSource> dataSourceMap) {
